...
```bash
python scripts/run_search.py --output-dir data/pike-data --strategy pike-b --level 3-pike --server-type cborg --model-name lbl/gpt-oss-120b-high --run-name h100_level_3-pike_pike-b --task-start 1 --task-end 50
```
