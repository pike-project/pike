...
if __name__ == "__main__":
    ...
    # target_dir = "KernelBench/level3-pike"
    search_terms = ["half", "float16"]
    # search_terms = ["@triton"]
    # search_terms = ["torch/extension.h", "cuda_runtime.h", "__syncthreads"]
    num_files, found_filenames = count_files_with_any_string(target_dir, search_terms)
