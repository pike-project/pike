...
def main():
    ...
    parser.add_argument("--max-fix-attempts", type=int, required=True)
    parser.add_argument("--eval-port", type=int, default=8000, required=False)
    parser.add_argument("--dry-run", action='store_true', default=False, required=False)
    parser.add_argument("--query-budget", type=int, default=300, required=False)
